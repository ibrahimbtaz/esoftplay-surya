...
<div id="menu-list">
	<ul class="nav-list">
		...
		<li class="dropdown magz-dropdown magz-dropdown-megamenu"><a href="#">Mega Menu <i class="ion-ios-arrow-right"></i>
							...
							<div class="row">
								...
								<article class="article col-md-4 mini">
									<div class="inner">
										<figure>
											<a href="single.html">
												<img src="templates/magz-master/images/news/img11.jpg" alt="Sample Article">
											</a>
										</figure>
										<div class="padding">
											<div class="detail">
								...
								<article class="article col-md-4 mini">
									<div class="inner">
										<figure>
											<a href="single.html">
												<img src="templates/magz-master/images/news/img14.jpg" alt="Sample Article">
											</a>
										</figure>
										<div class="padding">
											<div class="detail">
		...
		<div class="body-col vertical-slider" data-max="4" data-nav="#hot-news-nav" data-item="article">
			<article class="article-mini">
				<div class="inner">
					<figure>
						<a href="single.html">
							<img src="templates/magz-master/images/news/img09.jpg" alt="Sample Article">
						</a>
					</figure>
					<div class="padding">
			...
			<article class="article-mini">
				<div class="inner">
					<figure>
						<a href="single.html">
							<img src="templates/magz-master/images/news/img01.jpg" alt="Sample Article">
						</a>
					</figure>
					<div class="padding">
						<h1><a href="single.html">Duis aute irure dolor in reprehenderit in voluptate velit</a></h1>
			...
			<article class="article-mini">
				<div class="inner">
					<figure>
						<a href="single.html">
							<img src="templates/magz-master/images/news/img02.jpg" alt="Sample Article">
						</a>
					</figure>
					<div class="padding">
			...
			<article class="article-mini">
				<div class="inner">
					<figure>
						<a href="single.html">
							<img src="templates/magz-master/images/news/img13.jpg" alt="Sample Article">
						</a>
					</figure>
					<div class="padding">
						<h1><a href="single.html">Duis aute irure dolor in reprehenderit in voluptate velit</a></h1>
			...
			<article class="article-mini">
				<div class="inner">
					<figure>
						<a href="single.html">
							<img src="templates/magz-master/images/news/img08.jpg" alt="Sample Article">
						</a>
					</figure>
					<div class="padding">
...
<div class="row">
	...
	<article class="col-md-12 article-list">
		<div class="inner">
			<figure>
				<a href="single.html">
					<img src="templates/magz-master/images/news/img03.jpg" alt="Sample Article">
				</a>
			</figure>
			<div class="details">
				<div class="detail">
	...
	<div class="aside-body">
		<div class="featured-author">
			<div class="featured-author-inner">
				<div class="featured-author-cover" style="background-image: url('templates/magz-master/images/news/img15.jpg');">
					<div class="badges">
						<div class="badge-item"><i class="ion-star"></i> Featured</div>
					</div>
					<div class="featured-author-center">
						<figure class="featured-author-picture">
							<img src="templates/magz-master/images/img01.jpg" alt="Sample Article">
						</figure>
					...
					<div class="block">
						...
						<div class="block-body">
							<ul class="item-list-round" data-magnific="gallery">
								<li><a href="templates/magz-master/images/news/img06.jpg" style="background-image: url('templates/magz-master/images/news/img06.jpg');"></a></li>
								<li><a href="templates/magz-master/images/news/img07.jpg" style="background-image: url('templates/magz-master/images/news/img07.jpg');"></a></li>
								<li><a href="templates/magz-master/images/news/img08.jpg" style="background-image: url('templates/magz-master/images/news/img08.jpg');"></a></li>
								<li><a href="templates/magz-master/images/news/img09.jpg" style="background-image: url('templates/magz-master/images/news/img09.jpg');"></a></li>
								<li><a href="templates/magz-master/images/news/img10.jpg" style="background-image: url('templates/magz-master/images/news/img10.jpg');"></a></li>
								<li><a href="templates/magz-master/images/news/img11.jpg" style="background-image: url('templates/magz-master/images/news/img11.jpg');"></a></li>
								<li><a href="templates/magz-master/images/news/img12.jpg" style="background-image: url('templates/magz-master/images/news/img12.jpg');">
		...
		<div class="tab-pane active" id="recomended">
			<article class="article-fw">
				<div class="inner">
					<figure>
						<a href="single.html">
							<img src="templates/magz-master/images/news/img16.jpg" alt="Sample Article">
						</a>
					</figure>
					<div class="details">
						<div class="detail">
		...
		<div class="tab-pane comments" id="comments">
			<div class="comment-list sm">
				<div class="item">
					<div class="user">
						<figure>
							<img src="templates/magz-master/images/img01.jpg" alt="User Picture">
						</figure>
						<div class="details">
...
<aside id="sponsored">
	...
	<div class="aside-body">
		<ul class="sponsored">
			<li>
				<a href="#">
					<img src="templates/magz-master/images/sponsored.png" alt="Sponsored">
				</a>
			</li>
			<li>
				<a href="#">
...
<div class="owl-carousel owl-theme carousel-1">
	...
	<article class="article">
		<div class="inner">
			<figure>
				<a href="single.html">
					<img src="templates/magz-master/images/news/img15.jpg" alt="Sample Article">
				</a>
			</figure>
			<div class="padding">
				<div class="detail">
...
<div class="row">
		...
		<div class="block">
			...
			<div class="block-body">
				<figure class="foot-logo">
					<img src="templates/magz-master/images/logo-light.png" class="img-responsive" alt="Logo">
				</figure>
	...
	<div class="col-md-3 col-sm-6 col-xs-12">
		<div class="block">
			<h1 class="block-title">Popular Tags <div class="right"><a href="#">See All <i class="ion-ios-arrow-thin-right"></i></a></div>
			</h1>
			<div class="block-body">
				<ul class="tags">
					<li><a href="#">HTML5</a></li>
			...
			<div class="block-body">
				<article class="article-mini">
					<div class="inner">
						<figure>
							<a href="single.html">
								<img src="templates/magz-master/images/news/img12.jpg" alt="Sample Article">
							</a>
						</figure>
						<div class="padding">
...
<li class="dropdown magz-dropdown">
	...
	<ul class="dropdown-menu" role="menu">
		<li>
			<a href="http://localhost/surya/hot-list.html" title="Hot List">Hot List</a>
		</li>
		<li>
			<a href="http://localhost/surya/information.html" title="Information">Information</a>
		</li>
		<li>
			<a href="http://localhost/surya/relaxing.html" title="Relaxing">Relaxing</a>
		</li>
	</ul>
</li>
